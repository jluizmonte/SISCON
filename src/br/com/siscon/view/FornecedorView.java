...
public class FornecedorView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Fornecedor");
        setPreferredSize(new java.awt.Dimension(622, 550));
        ...
        jtFornecedor.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jtFornecedor.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código", "Fornecedor", "Endereço", "Telefone"
            }
        ) {
    ...
    private void jbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAlterarActionPerformed
        ...
        try {
            ...
            jtfEndereco.setText(fornecedorModel.getRuaFornecedor());
            ...
            jcbUf.setSelectedItem(fornecedorModel.getUfFornecedor());
    ...
    public void carregarFornecedor() {
        ...
        int cont = listaFornecedorModel.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaFornecedorModel.get(i).getCodigoFornecedor(),
                listaFornecedorModel.get(i).getNomeFornecedor(),
                listaFornecedorModel.get(i).getRuaFornecedor(),
                listaFornecedorModel.get(i).getTelefoneFornecedor()
            });
        }
    }
    ...
    private void salvarFornecedor() {
        ...
        fornecedorModel.setRuaFornecedor(jtfEndereco.getText().toUpperCase());
        ...
        fornecedorModel.setUfFornecedor(jcbUf.getSelectedItem().toString());
        ...
        if (fornecedorService.salvarFornecedorDAO(fornecedorModel) > 0) {
            JOptionPane.showMessageDialog(this, "Fornecedor: " + fornecedorModel.getNomeFornecedor() + " cadastrado com sucesso!", "Atenção", JOptionPane.WARNING_MESSAGE);
            jbSalvar.setText("Salvar");
            carregarFornecedor();
            limparCampos();
            desabilitaHabilitaCampos(false);
